---
name: remotion
description: Guide for building Remotion-based video applications with React. Use whenever the user asks to create, edit, render, or debug videos built with Remotion — including compositions, frame-based animations (useCurrentFrame, interpolate, spring), sequencing (Sequence, Series, TransitionSeries), layering (AbsoluteFill), and media elements (OffthreadVideo, Img, Audio, Gif).
---
